...
What the user's setup and preferences report. Grouped by meaning, not
mechanism.
...
Only `useIsReducedMotion` touches the shared store
(`../shared/useMediaQuery`); the other two keep their own tiny sources.
