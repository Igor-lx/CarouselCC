...
const numericRules: NumericRule[] = [
  ...
  },
  {
    ...
    consequence: "Repeated-click retarget scheduling becomes invalid",
  ...
  {
    layer: "Slides",
    field: "PRELOAD_NEIGHBOR_PAGE_SPAN",
    value: PRELOAD_NEIGHBOR_PAGE_SPAN,
    severity: "LOGICAL",
    expected: "Expected a non-negative finite integer",
    consequence: "Idle image predecode window becomes invalid",
    predicate: isNonNegativeInteger,
  },
  {
    layer: "Slides",
