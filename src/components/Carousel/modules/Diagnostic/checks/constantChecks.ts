...
const numericRules: NumericRule[] = [
  ...
  },
  {
    ...
    value: REPEATED_CLICK_DESTINATION_POSITION,
    severity: "LOGICAL",
    expected: "Expected a finite number greater than 0 (1 is the product baseline)",
    consequence: "The fast segment lands at the wrong fraction of the next page step",
    predicate: greaterThan(0),
  },
  {
    layer: "Motion",
    field: "REPEATED_CLICK_TOUCH_DESTINATION_POSITION",
    value: REPEATED_CLICK_TOUCH_DESTINATION_POSITION,
    severity: "LOGICAL",
    expected: "Expected a finite number greater than 0 (0.99 is the product baseline)",
    consequence: "Touch repeated-click handoff position becomes inconsistent with desktop",
    predicate: greaterThan(0),
  },
  {
    layer: "Motion",
  ...
  },
  {
    ...
    value: REPEATED_CLICK_EPSILON,
    severity: "CRITICAL",
    expected: "Expected a small positive finite number (e.g. 1e-4)",
    consequence: "Repeated-click follow-up gating becomes unstable; segments restart unexpectedly",
    predicate: greaterThan(0),
  },
  {
    layer: "Motion",
