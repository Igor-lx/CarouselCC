...
**Числа проверок здесь нет намеренно:** вывод печатает девять разделов, часть из
них покрывает по две сверки, и любое одно число тут же расходится с одним из
трёх счётов. Перечень и есть определение.
