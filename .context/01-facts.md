...
| Тесты | `npm test` | **117 файлов / 1124 теста — все зелёные** |
...
| Мутации (по требованию) | `npm run test:mutation` | **95.98 %** по `domain` и `state`: убито 741, выжило 30, без покрытия 1, таймаутов 0. Прогон ~5 минут. Все 30 разобраны поимённо и признаны неубиваемыми — разбор в `08-tests.md`, § E |
