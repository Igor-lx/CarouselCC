...
| Тесты | `npm test` | **142 файла / 1601 тест — все зелёные** |
...
| Покрытие | `npm run test:coverage` | строки **92.63 %** (3973/4289), ветки **86.60 %** (2204/2545), функции **91.87 %** (859/935), инструкции **91.20 %** (4334/4752) |
