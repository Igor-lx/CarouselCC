...
| Тесты | `npm test` | **124 файла / 1267 тестов — все зелёные** |
...
| Мутации (по требованию) | `npm run test:mutation` | **96.09 %** по `domain`, `state` и `config/resolve`: убито 762, выжило 30, без покрытия 1, таймаутов 0. Прогон ~6 минут. Все 30 разобраны поимённо и признаны неубиваемыми — разбор в `08-tests.md`, § E |
