...
| Мутации (по требованию) | `npm run test:mutation` | **81.69 %** по всей отгружаемой области одним прогоном: убито 4588, таймаутов 17, выжило 969, без покрытия 61, ошибок 2 из 5637 засчитанных; живых **1032**. Строковых мутантов 469 — помечены `Ignored`, в знаменатель **не входят**. 122 файла, тестовых среди них ноль. Прогон ~69 минут. По слоям: домен и состояние 96.8 %, движение клиента 91.1 %, ядро движения 90.3 %, движок жеста 83.3 %, DOM и геометрия 82.8 %, полки состояния 80.6 %, жест клиента 72.6 %, модули 64.3 %. Выжившие разобраны поимённо по областям: `08-tests.md` — § E (домен и состояние), § G (ядро движения), § H2 (жест), § H3 (DOM и геометрия), § H4 (обвязка и презентация) |
