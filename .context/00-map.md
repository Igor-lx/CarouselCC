...
### L3. Остальные модули — ждут своего захода

Записи ниже перенесены как есть, без сплошного чтения: они будут переписаны
следующим заходом (Controls, Diagnostic, ResponsiveImages).
