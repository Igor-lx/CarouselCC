...
- `planChannelRef` создаётся лениво прямо в рендере
  ...
  правило реагирует на условное чтение рефа, а не на эту форму. Знать при возврате к правилам
  React Compiler.
...
генератора; `data-gen/index.ts` (35) — бочка, которой никто не пользуется.
