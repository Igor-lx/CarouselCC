...
### `client/domain/slides.ts` (97) — pure
...
### `shared/engines/motion/` (12 файлов, 1162) — движок движения
...
- `runtime/createMotionController.ts` (257) — SSOT позиции.
...
### `shared/engines/kinetic/` (26 файлов, 2296) — фасад-сборка
